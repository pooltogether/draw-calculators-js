...
import { drawCalculator } from '../src/drawCalculator';
...
describe('findBitMatchesAtIndex()', () => {
    it('Can findBitMatchesAtIndex', async () => {
        const result = findBitMatchesAtIndex(BigNumber.from(61676), BigNumber.from(61612), 1, 8);
        expect(result).to.be.true;
    });

    it('Can NOT findBitMatchesAtIndex', async () => {
        const result = findBitMatchesAtIndex(BigNumber.from(61676), BigNumber.from(61612), 1, 6);
