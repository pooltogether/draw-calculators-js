...
export function calculatePrizeAmount(prizeDistribution: PrizeDistribution, matches :number): PickPrize | undefined{ // returns the prize you would receive for drawSettings and number of matches
    ...
    if(distributionIndex < prizeDistribution.distributions.length){
        ...
        const expectedPrizeAmount = calculatePrizeForDistributionIndex(distributionIndex, prizeDistribution)
        return {
