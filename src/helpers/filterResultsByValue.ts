...
export function filterPicksByValue(drawResults: DrawResults, drawSettings: TsunamiDrawSettings) : DrawResults{
    ...
    if(drawResults.prizes.length > drawSettings.maxPicksPerUser.toNumber()){
        // sort by value
        ...
        const sortedDescendingSortedPrizes = descendingSortedPrizes.slice(0, drawSettings.maxPicksPerUser.toNumber())
